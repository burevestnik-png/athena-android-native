...
опробываю различные возможности Android SDK, различные библиотеки и архитектурные решения.
...
Проект находится в активной стадии разработки и будет разрастаться :]
...
Опыт написания юнит тестов есть, но нужно разобраться с тестированием тех же самых репохиториев и
вебсокет слушателей, а так же и с тестированием представления.

### Оффлайн режим

Тема, которая реализована на данный момент частично, только в `createChat` feature. Там проиходит
...
Модель приложения не тривиальна и чтобы реализвать оставшийся кэш нужно порисовать UML диаграммы и
...
Цель проекта Афины мне, как разработчика попробывать весь современный стек разработки и определиться
